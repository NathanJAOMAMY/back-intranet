...
const { sendMessage, getMessages, setConversationUser, updateConversationUser, setChatConvesation, getChatConvesation, getConversationUsers, updatedConversation, findConversationUser,} = require("../controllers/chatController.js");
...
Router.get("/findConversationUser/:idConversation/:idUser", findConversationUser); // Récupérer les utilisateurs d'une conversation
